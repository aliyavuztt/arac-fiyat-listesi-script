...
- `docs/Toyota_2026-06-15_2129.xlsx` — yalnızca Toyota modelleri
...
- **KampanyaliFiyat:** Varsa kampanyalı fiyat, yoksa boş. Opel ve Toyota'da
  kullanılır; Renault ve Dacia'da bu kolon her zaman boştur. Gerçek sayı.
- **ParaBirimi:** Renault ve Dacia için `₺`, Opel ve Toyota için `TL`. Fiyat
  kolonlarında sembol olmadığı için para birimi buradan okunur.
